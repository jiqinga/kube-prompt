...
![demo](https://github.com/jiqinga/assets/raw/master/kube-prompt/kube-prompt.gif)
...
Binaries are available from [github release](https://github.com/jiqinga/kube-prompt/releases).
...
```
wget https://github.com/jiqinga/kube-prompt/releases/download/v1.0.11/kube-prompt_v1.0.11_linux_386.zip
...
```
wget https://github.com/jiqinga/kube-prompt/releases/download/v1.0.11/kube-prompt_v1.0.11_linux_arm64.zip
...
```console
$ brew install jiqinga/kube-prompt/kube-prompt
```
...
* Github: [@c-bata](https://github.com/jiqinga/)

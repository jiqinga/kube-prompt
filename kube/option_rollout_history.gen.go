...
var rolloutHistoryOptions = []prompt.Suggest{
	...
	{Text: "--revision", Description: "查看指定修订版本的详细信息，包括 Pod 模板 "},
	{Text: "--template", Description: "当 -o=go-template 或 -o=go-template-file 时，用于使用的模板字符串或模板文件的路径。该模板格式为 golang 模板 [http] : //golang.org/pkg/text/template/#pkg-overview]."},
}

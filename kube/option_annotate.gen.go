...
var annotateOptions = []prompt.Suggest{
	...
	{Text: "-f", Description: "Filename, directory, or URL to files identifying the resource to update the annotation"},
	{Text: "--filename", Description: "Filename, directory, or URL to files identifying the resource to update the annotation"},
	...
	{Text: "--local", Description: "If true, annotation will NOT contact api-server but run locally."},

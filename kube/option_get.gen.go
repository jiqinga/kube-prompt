...
var getOptions = []prompt.Suggest{
	...
	{Text: "--experimental-server-print", Description: "If true, have the server return the appropriate table output. Supports extension APIs and CRD. Experimental."},
	...
	{Text: "--use-openapi-print-columns", Description: "If true, use x-kubernetes-print-column metadata (if present) from the OpenAPI schema for displaying a resource."},

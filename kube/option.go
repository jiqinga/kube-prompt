...
var globalOptions = []prompt.Suggest{
	{Text: "--namespace", Description: "临时设置一个请求的命名空间。"},
	{Text: "-n", Description: "临时设置一个请求的命名空间。"},
	{Text: "--server", Description: "指定 Kubernetes API 服务器的地址和端口。"},
	{Text: "-s", Description: "指定 Kubernetes API 服务器的地址和端口。"},
	{Text: "--user", Description: "如果此标志存在，则接纳用户。"},
	{Text: "--cluster", Description: "如果此标志存在，则接管集群。"},
}
